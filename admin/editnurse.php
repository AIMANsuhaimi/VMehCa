...
$sqldisplay = "SELECT * FROM nurse2 WHERE id ='$sid'";
...
<body>
    <div class="container">
        <main class="form-wrapper">
            <h1 class="form-title">Edit Nurse Info</h1>
            <form name="editnurse" method="post" action="editnurseprocess.php" enctype="multipart/form-data">
                <div class="form-group">
                    <input type="hidden" class="input-field" name="stdid" value="<?= $row['id']; ?>">

                    <input type="text" class="input-field" name="name" placeholder="Name" value="<?= $row['username']; ?>" required>
