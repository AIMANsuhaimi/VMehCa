...
if(isset($_POST['register'])){
    ...
    if(empty($name) || empty($email) || empty($password)) {
        ...
        $cmdadd1 = "INSERT INTO doctor (name, password,email) VALUES ('$name', '$password', '$email')";
        ...
        if($result1 && $result2){
            ?>
             <script>
                alert("Successfully recorded in the database!");
                window.location.href = 'docrec.php'; // Redirect to a success page or any other page
            </script>
            <?php
        } else {
