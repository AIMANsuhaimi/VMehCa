...
if (isset($_POST['cari'])) {
    ...
    $cmdselect = "SELECT * FROM doctor WHERE name LIKE '%$silacari%'";
} else {
    $cmdselect = "SELECT * FROM doctor";
}
?>
                ...
                <tbody>
                    ...
                    if ($resultselect->num_rows > 0) {
                        while ($data = $resultselect->fetch_assoc()) {
                            ...
                            <tr>
                                <td><?= $no; ?></td>
                                <td data-label="Doctor Name"><?= $data['name']; ?></td>
                                ...
                                <td data-label="Actions">
                                    <div class="btndoc">
                                        ...
                                        <a href="removedoc.php?stdid=<?= $data['id'] ?>"
                        ...
                        echo "<tr><td colspan='5'>ERROR: No records found</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
