...
<body>
    <header>
        <nav>
            <ul>
                ...
                <li><a href="/fyp/signup.php">Register patient</a></li>
                <li><a href="appoinrec.php">Patient Record</a></li>
    ...
    <section class="services">
        <div class="container">
            <div class="service">
                <button onclick="window.location.href='/fyp/signup.php';">
                    <img src="/fyp/img/reg.png" alt="Online Consultation">
